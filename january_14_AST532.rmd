---
title: "Basic care and feeding of data in R (Borrowed from STAT 545 UBC)"
author: "Rashed"
...
Enter `getwd()` in the Console to see current working directory or, in RStudio, this is displayed in the bar at the top of Console.
...
We will work with some of the data from the [Gapminder project](http://www.gapminder.org). We can install it from CRAN like so:
...
This [Janus](http://en.wikipedia.org/wiki/Janus)-like nature of factors means they are rich with booby traps for the unsuspecting but they are a necessary evil. The pros far outweigh the cons. Specifically in modelling and figure-making, factors are anticipated and accommodated by the functions and packages you will want to exploit.
